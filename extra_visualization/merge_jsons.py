...
if __name__ == "__main__":
    ...
    # file_suffixes = ["ConnectionTool", "ElbowConnectionTool", "EllipseTool", "Initialization", "LineTool", "MenuAlign",
    #                 "MenuAttributes", "MenuDebug", "MenuEdit", "MenuFile", "PolygonTool", "RectangleTool", "RoundRectangleTool",
    #                 "SelectionTool", "TextTool"]
    # file_suffixes = ["3DS", "Applet", "Bootstrap", "Exception", "HomePlan", "Photo", "TestCases", "Viewer"]
    file_suffixes = ["abstractinput", "part1input", "part2input"]
